...
DROP TABLE parent2; -- silinmedi
DROP TABLE parent2 CASCADE; -- ZORLA SILDI

--SORU3 child2 tablosunu silin
drop table child2;
...
--SORU-4: Malzemeler tablosundaki musteri_isim'i Asli Can olan kaydin malzeme_isimini,
...
DELETE FROM toptancilar CASCADE;
TRUNCATE TABLE malzemeler;
...
--Arac tablosundaki ortalama fiyati bulun
