...
UPDATE urunler
SET urun_isim = 'Telephone' where urun_isim = 'Phone';
...
-- tablolari resetliyoruz simdi
-- --  urunler tablosundan Ali Bak’in aldigi urunun ismini, tedarikci  tablosunda irtibat_ismi 
-- 'Adam Eve' olan firmanın ismi (firma_ismi) ile degistiriniz.
update urunler SET urun_isim = (select firma_ismi from tedarikciler where tedarikciler.irtibat_ismi = 'Adam Eve')
